...
export { default as FeaturesGrid } from "./features-grid/index";
export { default as WindowActions } from "./window-actions";
export { default as CodeBlock } from "./code-block/";
export { default as ComparationSection } from "./comparison/comparison";
...
export { default as SparkSection } from "./spark-section"
